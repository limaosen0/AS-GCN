...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, num_class, graph_args,
        ...
        self.recon_layer_6 = StgcnReconBlock(128+3, 64, (1, spatial_kernel_size), self.edge_type, stride=1, padding=False, **kwargs)
        self.recon_layer_7 = StgcnReconBlock(64+3,  32, (1, spatial_kernel_size), self.edge_type, stride=1, padding=False, **kwargs)
        self.recon_layer_8 = StgcnReconBlock(32+3,  30, (1, spatial_kernel_size), self.edge_type, stride=1, padding=False, residual=False, activation=None, **kwargs)
    ...
    def forward(self, x, x_target, x_last, A_act):
        ...
        h0, _ = self.class_layer_0(x_bn, self.A * self.edge_importance[0], A_act)       # [N, 64, 300, 25]
        h1, _ = self.class_layer_1(h0, self.A * self.edge_importance[1], A_act)         # [N, 64, 300, 25]
        h2, _ = self.class_layer_2(h1, self.A * self.edge_importance[2], A_act)         # [N, 64, 300, 25]
        h3, _ = self.class_layer_3(h2, self.A * self.edge_importance[3], A_act)         # [N, 128, 150, 25]
        h4, _ = self.class_layer_4(h3, self.A * self.edge_importance[4], A_act)         # [N, 128, 150, 25]
        h5, _ = self.class_layer_5(h4, self.A * self.edge_importance[5], A_act)         # [N, 128, 150, 25]
        h6, _ = self.class_layer_6(h5, self.A * self.edge_importance[6], A_act)         # [N, 256, 75, 25]
        h7, _ = self.class_layer_7(h6, self.A * self.edge_importance[7], A_act)         # [N, 256, 75, 25]
        h8, _ = self.class_layer_8(h7, self.A * self.edge_importance[8], A_act)         # [N, 256, 75, 25]
